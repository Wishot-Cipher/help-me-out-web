  ...
  return (
    <Layout showFooter={true}>
      <div className="w-full h-auto bg-white-300">
        {/* Header */}
        <div className="w-full h-full max-h-[700px] bg-white-100 py-[5em] px-[4em] flex flex-col md:flex-row items-start justify-between gap-9">
          <div className="left w-full md:w-1/2 flex flex-col items-start justify-start">
          ...
          <div className="right w-full md:w-1/2 h-[300px]">
